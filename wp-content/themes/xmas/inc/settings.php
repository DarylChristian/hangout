<?php
    ...
    $settings = array(
		...
		'slider'=>array(
			...
			'content'=>array(
				'txt'=>array(
					'type'=>'p','name'=>'','value'=>'Recommended thumbnail size is 1000x436px'
				),
				'source'=>array(
		...
		'layout'=>array(
			...
			'content'=>array(
				...
				'imgwidth'=>array(
					'type'=>'text','name'=>'imgwidth','value'=>'258','ttl'=>'Loop image width', 'hint'=>'Featured images width (px)'
				)
				,
				'imgheight'=>array(
			...
			'content'=>array(
				...
				'sitemap'=>array(
					...
					'content'=>array(
						...
						'posted'=>array( 
							'type'=>'text','name'=>'posted','value'=>'','ttl'=>'Category text'
						),
						'searchresults'=>array(
